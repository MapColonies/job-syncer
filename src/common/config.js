...
var config_1 = require('@map-colonies/config');
var schemas_1 = require('@map-colonies/schemas');
var configInstance;
/**
 ...
 */
function initConfig(offlineMode) {
      ...
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            (0, config_1.config)({
              schema: schemas_1.commonBoilerplateV2,
              offlineMode: offlineMode,
            }),
          ];
        case 1:
          configInstance = _a.sent();
          return [2 /*return*/];
      }
    });
  });
